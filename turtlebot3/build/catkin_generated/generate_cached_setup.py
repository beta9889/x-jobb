...
try:
    ...
    for workspace in 'C:/ws/turtlebot3/devel;C:/opt/ros/melodic/x64'.split(';'):
...
code = generate_environment_script('C:/ws/turtlebot3/devel/env.bat')

output_filename = 'C:/ws/turtlebot3/build/catkin_generated/setup_cached.bat'
